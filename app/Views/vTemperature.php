        ...
        <div class="row row-deck row-cards">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo base_url('temperature/saveTemperature'); ?>" method="post">
                            <div class="row">
                                <div class="col-lg-6">
                                        ...
                                        <div class="col">
                                            <div>
                                                <?php
                                                    ...
                                                    foreach($getTemperatureByStoreDate as $t) {
                                                ...
                                                <input onclick="return false;" <?php if($time1 == 5) { echo("disabled"); } ?>checked id="time" name="time" type="checkbox" value="13:00:00" class="<?= ($validation->hasError('time')) ? 'is-invalid' : ''; ?>">
                                                <span <?php if($time1 == 5) { echo("style='opacity: 50%;'"); } ?>>13.00</span>
                                        ...
                                        <table class="table table-bordered card-table table-vcenter text-nowrap datatable" style="width:100%">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Zone 1<br>24&deg;C - 26&deg;C</td>
                                                    <td>
                                                        <div class="row">
                                                            <div class="col">
                                                ...
                                                <tr>
                                                    <td style="padding-left: 8px;">Zone 2<br>24&deg;C - 26&deg;C</td>
                                                    <td>
                                                        <div class="row">
                                                            <div class="col">
                                                ...
                                                <tr>
                                                    <td style="padding-left: 8px;">Zone 3<br>24&deg;C - 26&deg;C</td>
                                                    <td>
                                                        <div class="row">
                                                            <div class="col">
                                                ...
                                                <tr>
                                                    <td style="padding-left: 8px;">Zone 4<br>24&deg;C - 26&deg;C</td>
                                                    <td>
                                                        <div class="row">
                                                            <div class="col">
                            ...
                            <div class="form-footer">
                                <div class="row align-items-center">
                                    <div class="col"></div>
                                    <div class="col-auto">
                                        <button type="submit" class="btn btn-outline-primary ms-auto" id="btnSubmitTemperature" name="btnSubmitTemperature">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Data Suhu</h3>
                    </div>
                        ...
                        <table id="dynamic-table" class="table card-table table-vcenter text-nowrap datatable" style="width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <?php for($k = 1; $k <= 4; $k++): ?>
                                    <?php for($l = 1; $l <= 4; $l++): ?>
                                        <th>Area Jual Lantai <?= $k ?><br>Zone <?= $l ?><br>24&deg;C - 26&deg;C</th>
                                    <?php endfor; ?>
                                    <?php endfor; ?>
                            ...
                            <tbody>
                                <?php 
                                    ...
                                    $skipcounttmp = 0;
                                ?>
                                <?php foreach($getTemperatureByStore as $t): ?>
                                    <?php if($skipcount == 0): ?>
                                        <?php
                                            $j = 1;
                                            foreach($getTemperatureByStore as $a) {
                                        ...
                                        <tr>
                                            ...
                                            <?php for($k = 1; $k <= 5; $k++): ?>
                                                <?php if($t['area'] == $k): ?>
                                                    <td><?= $t['zone_1'] ?>&deg;C</td>
                                                    <td><?= $t['zone_2'] ?>&deg;C</td>
                                                    <td><?= $t['zone_3'] ?>&deg;C</td>
                                                    <td><?= $t['zone_4'] ?>&deg;C</td>
                                                <?php else: ?>
                                                    <?php
                                                        $j = 1;
                                                        $tmp = -1;
                                                        ...
                                                        if($tmp > 0) {
                                                            ...
                                                            foreach($getTemperatureByStore as $a) {
                                                                if($tmp == $j) {
                                                                    echo("<td>" . $a['zone_1'] . "&deg;C</td>");
                                                                    echo("<td>" . $a['zone_2'] . "&deg;C</td>");
                                                                    echo("<td>" . $a['zone_3'] . "&deg;C</td>");
                                                                    echo("<td>" . $a['zone_4'] . "&deg;C</td>");
                                    ...
                                    <div class="modal modal-blur fade" id="modal-editdata<?= $i; ?>" tabindex="-1" style="display: none;" aria-hidden="true">
                                        <form id="editTemperatureForm" action="<?php echo base_url('temperature/updateTemperature/' . $t['id']); ?>" method="post">
                                            <div class="modal-dialog modal-lg modal-dialog-centered" role="dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Edit Temperature Data (<?= $skipcounttmp - $skipcount + 1; ?>/<?= $skipcounttmp + 1; ?>)</h5>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input checked id="edittime" name="edittime" type="checkbox" onclick="return false;" value="13:00:00">
                                                                    <span>13.00</span>
                                                                </div>
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div style="padding: 10px; background-color: aliceblue;">
                                                                        ...
                                                                        <div class='row' style="margin: 0px;">
                                                                            <select name="editarea" id="editarea" class="editarea<?= $t['id'] ?> form-select <?= (($t['id'] == old('editid')) && ($validation->hasError('editarea'))) ? 'is-invalid' : ''; ?>" aria-label="Floating label select example">
                                                                                <?php for($m = 1; $m <= 4; $m++): ?>
                                                                                    <?php
                                                                                        $area = 0;
                                                                                        foreach($getTemperatureByStore as $tt) {
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Zone 1 24&deg;C - 26&deg;C</label>
                                                                        <div class='row' style="margin: 0px;">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Zone 2 24&deg;C - 26&deg;C</label>
                                                                        <div class='row' style="margin: 0px;">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Zone 3 24&deg;C - 26&deg;C</label>
                                                                        <div class='row' style="margin: 0px;">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Zone 4 24&deg;C - 26&deg;C</label>
                                                                        <div class='row' style="margin: 0px;">
                                                    ...
                                                    <div class="modal-footer justify-content-between">
                                                        ...
                                                        <div class="row align-items-center">
                                                            <div class="col"></div>
                                                            <div class="col-auto">
                                                                <button type="submit" class="btn btn-outline-primary ms-auto" id="btnUpdateTemperature" name="btnUpdateTemperature" data-bs-dismiss="modal" data-id="<?= $t['id']; ?>">
                                    ...
                                    <div class="modal modal-blur fade" id="modal-deletedata<?= $i; ?>" tabindex="-1" style="display: none;" aria-hidden="true">
                                        <form id="deleteTemperatureForm" action="<?php echo base_url('temperature/deleteTemperature/' . $t['id']); ?>" method="post">
                                            <div class="modal-dialog modal-lg modal-dialog-centered" role="dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Delete Temperature Data (<?= $skipcounttmp - $skipcount + 1; ?>/<?= $skipcounttmp + 1; ?>)</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-4">
                                                                ...
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input checked type="checkbox" onclick="return false;" value="13:00:00">
                                                                    <span>13.00</span>
                                                                </div>
                                                    ...
                                                    <div class="modal-footer justify-content-between">
                                                        ...
                                                        <div class="row align-items-center">
                                                            <div class="col"></div>
                                                            <div class="col-auto">
                                                                <button type="submit" class="btn btn-outline-danger ms-auto" id="btnDeleteTemperature" name="btnDeleteTemperature" data-bs-dismiss="modal" data-id="<?= $t['id']; ?>">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                                        <line x1="4" y1="7" x2="20" y2="7"></line>
                                                                        <line x1="10" y1="11" x2="10" y2="17"></line>
