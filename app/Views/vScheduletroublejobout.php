                                                ...
                                                <select name="dest_store" id="dest_store" class="form-select" id="floatingSelect" aria-label="Floating label select example" required>
                                                    ...
                                                    <?php foreach($getDataTableStore as $store): ?>
                                                        <?php if($store['idStore'] !== $idstore): ?>
                                                            <option value="<?= $store['idStore'] ?>" <?php if($store['idStore'] == old('dest_store')) { echo 'selected'; } ?>><?= $store['StoreName'] ?></option>
                                                        <?php endif; ?>
                                                    <?php endforeach; ?>
                                                </select>
                                                <label for="floatingSelect">Select store</label>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <div class="row g-2 align-items-center mb-n3">
                                                        ...
                                                        <div class="col-6 col-sm-4 col-md-2 col-xl-auto mb-3">
                                                            <button href="#myModalEdit<?= $i; ?>" id="btnModalEdit<?= $ts['id']; ?>" data-bs-toggle="modal" data-bs-target="#modal-editdata<?= $i; ?>" class="btn btn-outline-success w-100 btn-icon btn-edit" data-id="<?= $ts['id']; ?>" data-startdate="<?= $ts['start_date']; ?>" data-enddate="<?= $ts['end_date']; ?>" data-initstore="<?= $ts['init_store_id'] ?>" data-deststore="<?= $ts['dest_store_id'] ?>" data-workerid="<?= $ts['worker_id']; ?>" data-description="<?= $ts['description']; ?>">
                                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                                                ...
                                                                <div class="col-lg-4">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <select class="form-select" id="editdeststore" name="editdeststore" required>
                                                                            ...
                                                                            <?php foreach($getDataTableStore as $store): ?>
                                                                                <?php if($store['idStore'] !== $idstore): ?>
                                                                                    <option value="<?= $store['idStore']; ?>" <?php if($ts['dest_store_id'] == $store['idStore']) {echo 'selected';} ?>>
                                                                                        <?= $store['StoreName'] ?>
                                                                                    </option>
                                                                                <?php endif; ?>
                                                                            <?php endforeach; ?>
...
<script>
    $(document).ready(function() {
        ...
        // const editStartDatePicker = new Litepicker({
        //     element: document.getElementById('editstartdate'),
        //     buttonText: {
        //         previousMonth: `
        //         <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><polyline points="15 6 9 12 15 18" /></svg>`,
        //         nextMonth: `
        ...
        // const editEndDatePicker = new Litepicker({
        //     element: document.getElementById('editenddate'),
        //     buttonText: {
        //         previousMonth: `
        //         <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><polyline points="15 6 9 12 15 18" /></svg>`,
        //         nextMonth: `
        ...
        var old_worker_id = "<?= old('worker_id') ?>"
        ...
        $.ajax({
            url: "<?= base_url('troublejobout/checkWorkerJobAjax') ?>",
            type: "POST",
            data: form,
            headers: {
            ...
            success: function(data) {
                if(data != null) {
                    $("#worker_id").find("option").remove().end();

                    if(old_worker_id != null) {
                        $("#worker_id").append(
                            '<option value="">Select worker</option>'
                        );
                        data.worker.forEach(element => {
                            if(element.id == old_worker_id) {
                                $("#worker_id").append(
        ...
        startDatePicker.on('selected', function() {
            ...
            formInput.append("start_date", start_date.val());
            formInput.append("end_date", end_date.val());
