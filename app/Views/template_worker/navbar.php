        ...
        <div class="container-xxl">
            ...
            <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                <a href=".">
                    ...
                    <img src="./images/logo/logo2.svg" width="110" height="32" alt="Tabler" class="navbar-brand-image">
                </a>
            </h1>
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                        ...
                        <div class="d-none d-xl-block ps-2">
                            <div><?= $name; ?></div>
                            <div class="mt-1 small text-muted"><?= $roleuser . ' - ' . $location; ?></div>
                        </div>
                    </a>
                            ...
                            <div class="dropdown-menu">
                                <div class="dropdown-menu-columns">
                                    <div class="dropdown-menu-column">
                                                        ...
                                                        <div class="dropdown-menu-column">
                                                            ...
                                                            <?php if ($isGensetFound) : ?>
                                                                <div class="dropend">
                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        <a href="genset1" class="dropdown-item">
                                                                            Genset 1
                                                                        </a>
                                                                        <a href="genset2" class="dropdown-item">
                                                                            Genset 2
                                                                        </a>
                                                                    </div>
                                                                </div>
                                        ...
                                        <div class="dropend">
                                            ...
                                            <div class="dropdown-menu">
                                                <div class="dropend">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a href="techshift" class="dropdown-item">
                                                            Shift
                                                        </a>
                                                ...
                                                <div class="dropend">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a href="troubleshift" class="dropdown-item">
                                                            Shift
                                                        </a>
                                        ...
                                        <a class="dropdown-item" href="storeEquipment">
                                            <span class="nav-link-icon d-md-none d-lg-inline-block">
