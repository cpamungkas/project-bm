                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <div class="row g-2 align-items-center mb-n3">
                                                ...
                                                <div class="col-6 col-sm-4 col-md-2 col-xl-auto mb-3">
                                                    <!-- <button href="#myModalEdit<?= $i; ?>" id="btnModalEdit<?= $ts['idStore']; ?>" class="btn btn-outline-success w-100 btn-icon" aria-label="EditData" data-bs-toggle="modal" data-bs-target="#modal-editdata<?= $i; ?>"> -->
                                                    <button href="#myModalEdit<?= $i; ?>" id="btnModalEdit<?= $ts['idStore']; ?>" class="btn btn-outline-success w-100 btn-icon btn-edit" data-idstore="<?= $ts['idStore']; ?>" data-storecode="<?= $ts['StoreCode']; ?>" data-storename="<?= $ts['StoreName']; ?>" data-kwhmeter1="<?= $ts['idKWHMeter1']; ?>" data-idpln1="<?= $ts['idPLN1']; ?>" data-kwhmeter2="<?= $ts['idKWHMeter2']; ?>" data-idpln2="<?= $ts['idPLN2']; ?>">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
